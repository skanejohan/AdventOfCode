    ...
    public static class Runner2022
    {
        public static void TestAll()
        {
            try
            {
                ...
                Verifier.Verify(0, Y2022.Day01.Solver.Part1(), "day 1 part 1");
                Verifier.Verify(0, Y2022.Day01.Solver.Part2(), "day 1 part 2");
                ...
                Verifier.Verify(0, Y2022.Day04.Solver.Part2(), "day 4 part 2");
                Verifier.Verify(0, Y2022.Day05.Solver.Part1(), "day 5 part 1");
                Verifier.Verify(0, Y2022.Day05.Solver.Part2(), "day 5 part 2");
                Verifier.Verify(0, Y2022.Day06.Solver.Part1(), "day 6 part 1");
                Verifier.Verify(0, Y2022.Day06.Solver.Part2(), "day 6 part 2");
                ...
                Verifier.Verify(0, Y2022.Day09.Solver.Part2(), "day 9 part 2");
                Verifier.Verify(0, Y2022.Day10.Solver.Part1(), "day 10 part 1");
                Verifier.Verify(0, Y2022.Day10.Solver.Part2(), "day 10 part 2");
                Verifier.Verify(0, Y2022.Day11.Solver.Part1(), "day 11 part 1");
                Verifier.Verify(0, Y2022.Day11.Solver.Part2(), "day 11 part 2");
