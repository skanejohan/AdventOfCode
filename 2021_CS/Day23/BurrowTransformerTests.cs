...
namespace _2021_CS.Day23
{
    internal class BurrowTransformerTests
    {
        ...
        private static void AssertNeighborsPart1()
        {
            ...
            AssertContains((30, "B.......A..CD..BC..DA.."), cells);
            AssertContains((20, ".B......A..CD..BC..DA.."), cells);
            AssertContains((20, "..B.....A..CD..BC..DA.."), cells);
            AssertContains((40, "...B....A..CD..BC..DA.."), cells);
            AssertContains((60, "....B...A..CD..BC..DA.."), cells);
            AssertContains((80, ".....B..A..CD..BC..DA.."), cells);
            AssertContains((90, "......B.A..CD..BC..DA.."), cells);
            AssertContains((500, "C......BA...D..BC..DA.."), cells);
            AssertContains((400, ".C.....BA...D..BC..DA.."), cells);
            AssertContains((200, "..C....BA...D..BC..DA.."), cells);
            AssertContains((200, "...C...BA...D..BC..DA.."), cells);
            AssertContains((400, "....C..BA...D..BC..DA.."), cells);
            AssertContains((600, ".....C.BA...D..BC..DA.."), cells);
            AssertContains((700, "......CBA...D..BC..DA.."), cells);
            AssertContains((70, "B......BA..CD...C..DA.."), cells);
            AssertContains((60, ".B.....BA..CD...C..DA.."), cells);
            AssertContains((40, "..B....BA..CD...C..DA.."), cells);
            AssertContains((20, "...B...BA..CD...C..DA.."), cells);
            AssertContains((20, "....B..BA..CD...C..DA.."), cells);
            AssertContains((40, ".....B.BA..CD...C..DA.."), cells);
            AssertContains((50, "......BBA..CD...C..DA.."), cells);
            AssertContains((9000, "D......BA..CD..BC...A.."), cells);
            AssertContains((8000, ".D.....BA..CD..BC...A.."), cells);
            AssertContains((6000, "..D....BA..CD..BC...A.."), cells);
            AssertContains((4000, "...D...BA..CD..BC...A.."), cells);
            AssertContains((2000, "....D..BA..CD..BC...A.."), cells);
            AssertContains((2000, ".....D.BA..CD..BC...A.."), cells);
            AssertContains((3000, "......DBA..CD..BC...A.."), cells);
        }
